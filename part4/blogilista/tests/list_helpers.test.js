...
describe("totalLikes", () => {
  test("multiple blogs", () => {
    let likes = listHelpers.totalLikes(BLOGS)
...
describe("favoriteBlog", () => {
  ...
  test("no blogs", () => {
    expect(listHelpers.favoriteBlog([])).toBe(null)
  })
})
...
describe("mostBlogs", () => {
  test("multiple blogs", () => {
    ...
    expect(listHelpers.mostBlogs(BLOGS)).toEqual(expected)
  })
})
...
describe("mostLikes", () => {
  test("multiple blogs", () => {
    ...
    expect(listHelpers.mostLikes(BLOGS)).toEqual(expected)
  })
})
